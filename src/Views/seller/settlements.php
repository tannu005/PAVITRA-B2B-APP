    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border border-light p-4 bg-white mb-4">
                ...
                <p class="text-muted small mb-3">Viraasat operates on a standard <strong>T+3 settlement cycle</strong> for handloom weavers. Payouts are computed as follows:</p>
            ...
            <div class="card shadow-sm border border-light bg-light p-3 text-muted" style="font-size: 0.75rem;">
                ...
                • Holder: Viraasat Weavers Ltd.<br>
                • Account: ••••4567<br>
