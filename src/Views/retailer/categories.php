...
<div class="container py-4 my-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">
    ...
    <!-- Customization Studio Promo Banner -->
    <div class="card border-0 mb-5 overflow-hidden shadow-sm" style="border-radius: 16px; background: linear-gradient(135deg, var(--meesho-pink) 0%, #3D0A0A 100%); border: 1px solid rgba(201, 151, 46, 0.25) !important;">
        <div class="card-body p-4 p-md-5 text-white position-relative">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-4 col-12 text-lg-end">
                    <a href="/customization" class="btn btn-light rounded-0 px-4 py-2.5 text-uppercase fw-bold" style="font-size:0.75rem; letter-spacing:0.05em; color: var(--meesho-pink); border: 2px solid #FFF;">Open Design Studio</a>
                </div>
            </div>
    ...
    <div class="text-center mb-5">
        <h2 class="text-uppercase fw-normal mb-1" style="font-family: var(--font-headings); letter-spacing: 0.12em; color: var(--meesho-pink);">Weaver Business Directory</h2>
            ...
            <div class="col">
                <a href="/?category=<?= $store['slug'] ?>" class="text-decoration-none text-dark d-block h-100">
                    <div class="card h-100 border-0 shadow-sm p-4 text-center nisho-store-card" style="border-radius: 16px; background-color: #FFFDF8; border: 1px solid var(--premium-border) !important; transition: all 0.35s ease;">
                        ...
                        <!-- Store image / weave circular avatar -->
                        ...
                        <h4 class="h6 text-uppercase fw-bold mb-1" style="letter-spacing: 0.05em; color: var(--meesho-pink);"><?= htmlspecialchars($store['name']) ?></h4>
                        
                        <!-- Artisan & location metadata -->
                        ...
                        <div class="d-flex align-items-center justify-content-between border-top pt-3 mt-auto">
                            ...
                            <span class="text-uppercase fw-bold" style="font-size: 0.72rem; letter-spacing: 0.08em; color: var(--meesho-pink);">Visit Store →</span>
                        </div>
                    </div>
                </a>
            </div>
