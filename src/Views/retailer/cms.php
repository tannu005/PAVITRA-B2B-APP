        ...
        <div class="col-lg-9">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb" style="font-size: 0.85rem;">
                    <li class="breadcrumb-item"><a href="/" class="text-pink text-decoration-none"><i class="fa fa-home me-1"></i>Home</a></li>
            ...
            <div class="card shadow-sm border border-light p-4 p-md-5 bg-white rounded-3">
                <div class="border-bottom pb-3 mb-4">
                    <h1 class="fw-extrabold text-pink mb-2" style="color: #F43397; font-size: 2rem;"><?= htmlspecialchars($page['title']) ?></h1>
